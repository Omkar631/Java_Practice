...
//Method override from Overriding (parent)
public class Overridding1 extends Overridding {

	public static void main(String[] args)
	{
		
		//Method calling from same class
		Overridding obj=new Overridding1();
		obj.Swapping_Nos_without_third_variable(); 
		obj.Swapping_Nos_with_third_variable(); 
		
		//Method calling from parent class
		Overridding1 obj1=new Overridding1();
		obj1.Swapping_Nos_without_third_variable();  
		obj1.Swapping_Nos_with_third_variable();
